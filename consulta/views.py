...
class ConsultaResp(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            destino2 = [mail]
            mensaje_html2 = """<h1> Tu mensaje ha sido enviado exitosamente
            </h1><h2>En breve nos estaremos comunicando</<h2>
            <p>Este es un mail automático
            automático, , que no debe ser respondido. </p>"""
            ...
            desde2 = "info@dominio.org"
            destino2 = [mail]
            mensaje_html2 = "<h1> Tu mensaje ha sido enviado exitosamente</h1><h2>En breve nos estaremos comunicando</<h2><p>Este es un mail automático, , que no debe ser respondido. </p>"
            #send_mail(subject2, mensaje, desde2, destino2, html_message=mensaje_html2, fail_silently=False)
            ...
            params = {}
            params['form'] = form
            return HttpResponseRedirect('/vistaprevia')
        else:
